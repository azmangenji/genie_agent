# GMC sync_tree.csh - Sync GMC workspace
# Based on UMC sync_tree.csh, adapted for GMC project
# GMC uses: p4_mkwa -codeline umc4 -wacfg er
...
if ($p4file_count > 0) then
    # Example: //depot/gmc_ip/branches/GMC_BRANCH/...
...
if ($refdir_count  == 0 ) then
     ...
     # GMC uses codeline umc4 (not umc_ip)
     if ("$branch_name" != "") then
