# Lint LEARNING.md - Past Fixes and Solutions

**PURPOSE:** Documents past Lint violations and their confirmed fixes. Check this before analyzing — if a matching pattern exists, apply the same solution.
...
4. **Solution** - RTL fix OR waiver with code snippet

---

(No confirmed fixes yet)
